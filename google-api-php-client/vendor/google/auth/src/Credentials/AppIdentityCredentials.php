...
/**
 * This file used to supports authorization on Google App Engine.
 *
 * @author  Tech Banker
...
class AppIdentityCredentials extends CredentialsLoader {
	...
	public function fetchAuthToken( callable $httpHandler = null ) { // @codingStandardsIgnoreLine
		...
		$this->lastReceivedToken = $token; // @codingStandardsIgnoreLine

		return $token;
	}

	/**
	 * This function is used to get last received tokens
	 *
	 * @return array|null
	 */
	public function getLastReceivedToken() {
		if ( $this->lastReceivedToken ) { // @codingStandardsIgnoreLine
			return [
				...
				'expires_at'   => $this->lastReceivedToken['expiration_time'], // @codingStandardsIgnoreLine
			];
		}
