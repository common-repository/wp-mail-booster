	...
	if ( ! $access_granted ) {
		...
		if ( ! class_exists( 'Dbhelper_Mail_Booster' ) ) {
			...
			class Dbhelper_Mail_Booster {
				...
				/**
				 * This function is being used to delete multiple data from database.
				 *
				 * @param string $table_name .
				 * @param string $where .
				 * @param string $data .
		...
		if ( ! class_exists( 'Mail_Booster_Discover_Host' ) ) {
			 ...
			 * @author  Tech Banker
			 */
			class Mail_Booster_Discover_Host {// @codingStandardsIgnoreLine.
				/**
		...
		if ( ! class_exists( 'Plugin_Info_Wp_Mail_Booster' ) ) {
			/**
			 ...
			 * @author  Tech Banker
			 */
			class Plugin_Info_Wp_Mail_Booster {// @codingStandardsIgnoreLine.
				/**
				 * This function is used to return the information about plugins.
				 */
				public function get_plugin_info_wp_mail_booster() {
