...
/**
 * This file used for  Guzzle Subscriber that implements Google's Simple API
 *
 * @author  Tech Banker
...
class SimpleSubscriber implements SubscriberInterface {
	...
	public function onBefore( BeforeEvent $event ) {
		...
		if ( $request->getConfig()['auth'] != 'simple' ) { // @codingStandardsIgnoreLine
			return;
		}
