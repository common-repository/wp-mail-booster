...
if ( file_exists( MAIL_BOOSTER_DIR_PATH . 'includes/class-token-manager-mail-booster.php' ) ) {
	require_once MAIL_BOOSTER_DIR_PATH . 'includes/class-token-manager-mail-booster.php';
}
...
if ( ! class_exists( 'Google_Authentication_Mail_Booster' ) ) {
	...
	class Google_Authentication_Mail_Booster extends Token_Manager_Mail_Booster {
		 ...
		 *
		 * @param Mail_Booster_Manage_Token $client_id  represent clent id.
		 * @param Mail_Booster_Manage_Token $client_secret  represent clent secret.
		 * @param Mail_Booster_Manage_Token $authorization_token  represent authorization token.
		 * @param Mail_Booster_Manage_Token $callback_uri  represent callback uri.
		 * @param Mail_Booster_Manage_Token $sender_email  represent sender email.
		 */
