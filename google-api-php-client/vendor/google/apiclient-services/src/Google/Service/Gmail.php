...
/**
 * This file Access Gmail mailboxes including sending user email.
 *
 * @author  Tech Banker
...
class Google_Service_Gmail extends Google_Service {
	...
	public $users;
	/**
	 * Variable for users drafts
	 *
	 * @var $users_drafts .
	 */
	public $users_drafts;
	/**
	 * Variable for users history
	 *
	 * @var $users_history .
	 */
	public $users_history;
	/**
	 * Variable for users labels
	 *
	 * @var $users_labels .
	 */
	public $users_labels;
	/**
	 * Variable for users messages
	 *
	 * @var $users_messages .
	 */
	public $users_messages;
	/**
	 * Variable for users message attachmnets
	 *
	 * @var $users_messages_attachments .
	 */
	public $users_messages_attachments;
	/**
	 * Variable for users setings
	 *
	 * @var $users_settings .
	 */
	public $users_settings;
	/**
	 * Variable for users settings filter
	 *
	 * @var $users_settings_filters .
	 */
	public $users_settings_filters;
	/**
	 * Variable for users setting forward address
	 *
	 * @var $users_settings_forwardingAddresses .
	 */
	public $users_settings_forwardingAddresses; // @codingStandardsIgnoreLine
	/**
	 * Variable for users settings send
	 *
	 * @var $users_settings_sendAs .
	 */
	public $users_settings_sendAs; // @codingStandardsIgnoreLine
	/**
	 * Variable for users settings sendAs smimeInfo
	 *
	 * @var $users_settings_sendAs_smimeInfo .
	 */
	public $users_settings_sendAs_smimeInfo; // @codingStandardsIgnoreLine
	/**
	 * Variable for users threads
	 *
	 * @var $users_threads .
	 */
	...
	public function __construct( Google_Client $client ) {
		...
		$this->rootUrl     = 'https://www.googleapis.com/'; // @codingStandardsIgnoreLine
		$this->servicePath = 'gmail/v1/users/'; // @codingStandardsIgnoreLine
		$this->version     = 'v1';
		$this->serviceName = 'gmail'; // @codingStandardsIgnoreLine

		$this->users                              = new Google_Service_Gmail_Resource_Users(
			$this,
			$this->serviceName, // @codingStandardsIgnoreLine
			'users',
			array(
				'methods' => array(
					'getProfile' => array(
		...
		$this->users_settings_forwardingAddresses = new Google_Service_Gmail_Resource_UsersSettingsForwardingAddresses( // @codingStandardsIgnoreLine
			$this,
			$this->serviceName, // @codingStandardsIgnoreLine
			'forwardingAddresses',
			array(
		...
		$this->users_settings_sendAs              = new Google_Service_Gmail_Resource_UsersSettingsSendAs( // @codingStandardsIgnoreLine
			$this,
			$this->serviceName, // @codingStandardsIgnoreLine
			'sendAs',
			array(
		...
		$this->users_settings_sendAs_smimeInfo    = new Google_Service_Gmail_Resource_UsersSettingsSendAsSmimeInfo( // @codingStandardsIgnoreLine
			$this,
			$this->serviceName, // @codingStandardsIgnoreLine
			'smimeInfo',
			array(
