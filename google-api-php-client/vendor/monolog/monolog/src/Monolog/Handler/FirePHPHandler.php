...
class FirePHPHandler extends AbstractProcessingHandler {
	 ...
	 * @var int
	 */
	protected static $messageIndex = 1;// @codingStandardsIgnoreLine.
	...
	protected function createRecordHeader( array $record ) {
		...
		return $this->createHeader(
			array( 1, 1, 1, self::$messageIndex++ ),// @codingStandardsIgnoreLine.
			$record['formatted']
		);
	}
	...
	protected function headersAccepted() {
		if ( ! empty( $_SERVER['HTTP_USER_AGENT'] ) && preg_match( '{\bFirePHP/\d+\.\d+\b}', $_SERVER['HTTP_USER_AGENT'] ) ) {// @codingStandardsIgnoreLine.
			return true;
		}

		return isset( $_SERVER['HTTP_X_FIREPHP_VERSION'] );// @codingStandardsIgnoreLine.
	}
