...
/**
 * This file for Pure-PHP implementation of Triple DES.
 *
 * @author  Tech Banker
...
class TripleDES extends DES {
	 ...
	 * @access private
	 */
	var $key_length = 24; // @codingStandardsIgnoreLine
	 ...
	 * @access private
	 */
	var $cipher_name_mcrypt = 'tripledes'; // @codingStandardsIgnoreLine
	 ...
	 * @access private
	 */
	var $cfb_init_len = 750; // @codingStandardsIgnoreLine
	 ...
	 * @access private
	 */
	var $key_length_max = 24; // @codingStandardsIgnoreLine
	 ...
	 * @access private
	 */
	var $mode_3cbc; // @codingStandardsIgnoreLine
	 ...
	 * @access private
	 */
	var $des; // @codingStandardsIgnoreLine
	...
	public function isValidEngine( $engine ) {
		if ( self::ENGINE_OPENSSL == $engine ) { // WPCS: Loose comparison ok .
			...
			$this->cipher_name_openssl     = 'ecb' == $mode ? 'des-ede3' : 'des-ede3-' . $mode; // WPCS: Loose comparison ok .
		}
